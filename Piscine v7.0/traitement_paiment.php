        ...
        while ($data = mysqli_fetch_assoc($result)){
            ...
            if($verification == 4) {
                ...
                while ($data3 = mysqli_fetch_assoc($result3)) {
                    ...
                    echo "Id : " .$data3['Id']. "<br>";
                    echo "Id de l'acheteur : " .$_COOKIE['id']. "<br>";
                ...
                for ($nb = 0; $nb < count($PrixArticle); $nb++) {
                    ...
                    $total = $total + $QuantiteArticle[$nb]*$PrixArticle[$nb];
                }

                echo "Avant l'envoie du mail";
                echo "EMial a envoier : ".$data['Email']. "<br>";

                $to_email = "e.aras75@gmail.com";
                ...
                $message = "<html><head></head>
                    ...
                    "<h4>Le total est de " .$total. " euros</h4>
