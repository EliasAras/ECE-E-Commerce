...
<html>
    ...
    <body>
        ...
        <h3 id="titreCentrer">Créer votre compte Vendeur</h3>
    ...
    <form id="signUpForm" action="Ajout_Vendeur.php" method="post" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-outline-primary" value="submit" id="SignIn" name="SingIn" style="margin-top:40px">S'inscrire</button>
        </form>
    </div>
        <br><br>
