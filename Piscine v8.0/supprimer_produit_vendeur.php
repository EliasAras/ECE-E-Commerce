...
if ($db_found) {
    ...
    <div class="row" style="background-image:url(Images/FondEcrans/<?php echo $data['FondEcran']; ?> ); padding-bottom: 5%"
        ...
        <div class="card" style="margin-left: 15%; margin-top: 30px; float:right">
            ...
            <?php
            $sql = "SELECT Id, Nom, Image, Quantite, QuantiteVendue FROM vetements WHERE IdVendeur= " . $_COOKIE['id'] . " UNION SELECT Id, Nom, Image, Quantite, QuantiteVendue FROM livres WHERE  IdVendeur= " . $_COOKIE['id'] . " UNION SELECT Id, Nom, Image, Quantite, QuantiteVendue FROM musiques WHERE  IdVendeur= " . $_COOKIE['id'] . " UNION SELECT Id, Nom, Image, Quantite, QuantiteVendue FROM sportsetloisirs WHERE  IdVendeur= " . $_COOKIE['id'];
            $result = mysqli_query($db_handle, $sql); ?>
            ...
            <table border="0" style="margin-left: 10%">
                ...
                while ($data = mysqli_fetch_assoc($result)) { ?>
                    <tr style="padding-top: 100px">
                        <td><?php echo '<img src="Images/Produits/' . $data["Image"] . '"width="150" height="150">' ?></td>
                        <td style="font-weight: bold;">&nbsp;&nbsp;<?php echo $data['Nom']; ?>
                            <h5>
                                <small class="text-muted" style="font-size: small;">&nbsp;&nbsp&nbsp;<?php echo $data['Id']. "
                            <br> &nbsp;&nbsp; Quantite | " .$data['Quantite']. "<br>&nbsp;&nbsp; Vente | " .$data['QuantiteVendue']. "</small></h5>
