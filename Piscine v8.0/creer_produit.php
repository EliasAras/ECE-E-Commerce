        ...
        <div id="form_musique1">
            <form id="signUpForm" action="Ajout_Produit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        <label class="custom-file-label" for="customFile1">Video</label>
                        <input type="file" name="fileToUpload_Video_Musique" class="custom-file-input" id="exampleVideo">
                    </div>
                </div>
        ...
        <div id="form_sport1" style="display:none">
            <form id="signUpForm" action="Ajout_Produit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        <label class="custom-file-label" for="customFile1">Video</label>
                        <input type="file" name="fileToUpload_Video_SeL" class="custom-file-input" id="exampleVideo">
                    </div>
                </div>
                <button type="submit" class="btn btn-outline-primary" value="submit" name="SignIn" id="SignIn" style="margin-top: 10px; margin-bottom: 10px" >Ajouter votre produit</button>
            </form>
        ...
        <div id="form_liv1" style="display:none">
            <form id="signUpForm" action="Ajout_Produit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        <label class="custom-file-label" for="customFile1">Video</label>
                        <input type="file" name="fileToUpload_Video_Livre" class="custom-file-input" id="exampleVideo">
                    </div>
                </div>
                <button type="submit" class="btn btn-outline-primary" value="submit" name="SignIn" id="SignIn" style="margin-top: 10px; margin-bottom: 10px" >Ajouter votre produit</button>
            </form>
        ...
        <div id="form_vetement1" style="display:none">
            <form id="signUpForm" action="Ajout_Produit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        <label class="custom-file-label" for="customFile1">Video</label>
                        <input type="file" name="fileToUpload_Video_Vetement" class="custom-file-input" id="exampleVideo">
                    </div>
                </div>
                <button type="submit" class="btn btn-outline-primary" value="submit" name="SignIn" id="SignIn" style="margin-top: 10px; margin-bottom: 10px" >Ajouter votre produit</button>
            </form>
