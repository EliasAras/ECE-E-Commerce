...
<html>
    ...
    <form id="signUpForm" action="Ajout_Vendeur.php" method="post" enctype="multipart/form-data">
        ...
        <button type="submit" class="btn btn-outline-primary" value="submit" id="SignIn" name="SingIn" style="margin-top: 40px; margin-bottom: 10px">Créer votre Compte Vendeur</button>
        </form>
    </div>
