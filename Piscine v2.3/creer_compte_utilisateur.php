...
<html>
    ...
    <div class="form-header">
        ...
        <h4 class= ""><u>Informations de connexion</u></h4>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="number" name="NumeroCarte" class="form-control" id="inputNum_Carte" required pattern="[0-9]{16}">
        ...
        <button type="submit" class="btn btn-outline-primary" value="submit" id="SignIn" style="margin-top: 10px; margin-bottom: 10px">Créer votre Compte Utilisateur</button>
        </form>
    </div>
