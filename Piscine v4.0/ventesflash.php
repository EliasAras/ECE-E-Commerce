        ...
        <div class="container">
            <div class="row">
                ...
                while ($data = mysqli_fetch_assoc($result)) {
                    ...
                    <input type="text" name="nom" value="<?php echo $data['Nom']; ?>" style="display:none">
                    <input type="text" name="description" value="<?php echo $data['Description']; ?>"
                           style="display:none">
                    <input type="text" name="prix" value="<?php echo $data['Prix']; ?>" style="display:none">
                    <input type="text" name="image" value="<?php echo $data['Image']; ?>" style="display:none">
                ...
                while ($data1 = mysqli_fetch_assoc($result1)) {
                    ...
                    <input type="text" name="id" value="<?php echo $data1['Id']; ?>" style="display:none">
                    <input type="text" name="nom" value="<?php echo $data1['Nom']; ?>" style="display:none">
                    <input type="text" name="description" value="<?php echo $data1['Description']; ?>"
                           style="display:none">
                    <input type="text" name="prix" value="<?php echo $data1['Prix']; ?>" style="display:none">
                    <input type="text" name="image" value="<?php echo $data1['Image']; ?>" style="display:none">
                ...
                while ($data3 = mysqli_fetch_assoc($result3)) {
                    ...
                    <input type="text" name="id" value="<?php echo $data3['Id']; ?>" style="display:none">
                    <input type="text" name="nom" value="<?php echo $data3['Nom']; ?>" style="display:none">
                    <input type="text" name="description" value="<?php echo $data3['Description']; ?>"
                           style="display:none">
                    <input type="text" name="prix" value="<?php echo $data3['Prix']; ?>" style="display:none">
                    <input type="text" name="image" value="<?php echo $data3['Image']; ?>" style="display:none">
