...
insert into Panier (Id, IdAcheteur, Nom, Prix, Description, Image, Quantite) VALUES (40000015,30000000,"Pull homme",98,"pull coton fabrique en chine comme d habitude","pullbleu.jpg",2);
...
Insert into SportsEtLoisirs (Id, IdVendeur, NomSport, Nom, Prix, Description, Couleur, Marque, QuantiteVendue, Quantite, Image) values (40070012, 20000000 , "Tennis", "Raquette de tennis pro", 344, "Raquette de tennis pour competiteur", "rouge", "fedou", 63, 159, "raquetterouge.jpg");
...
Insert into Musiques (Id, IdVendeur, Nom, Prix, Duree, Artiste, Album, Style, Description, QuantiteVendue, Quantite, Image) values (41000019, 20000000 , "Monster", 4, 4, "Skillet", "Greater", "metal", "Musique au format mp3, haute qualité sonore", 2463156, 1000000, "skillet.jpg");
...
Insert into Livres (Id, IdVendeur, Nom, Prix, Description, NombrePage, Auteur, Editeur, QuantiteVendue, Quantite, Image) values (42589609, 20000000 , "Cabane Magique", 10, "Voyage dans le temps", 120, "Xavier de Caz", "chevava", 1037, 121, "cabanemagique.jpg");
